export default function SysComp({ data }) {
  ...
  return (
    <div className="h-96 w-full lg:w-1/3 bg-ctp-light-base dark:bg-ctp-dark-base p-6 rounded-2xl shadow-xl border-2 border-ctp-light-surface1 dark:border-ctp-dark-surface1 flex flex-col">
      ...
      <div className="grid grid-cols-2 grid-rows-2 gap-4 grow">
        ...
        <div className="flex flex-col items-center justify-center p-4 bg-ctp-light-surface0 dark:bg-ctp-dark-surface0 rounded-xl border-2 border-transparent hover:border-ctp-light-peach dark:hover:border-ctp-dark-peach transition-colors">
        ...
        <div className="flex flex-col items-center justify-center p-4 bg-ctp-light-surface0 dark:bg-ctp-dark-surface0 rounded-xl border-2 border-transparent hover:border-ctp-light-mauve dark:hover:border-ctp-dark-mauve transition-colors">
        ...
        <div className="flex flex-col items-center justify-center p-4 bg-ctp-light-surface0 dark:bg-ctp-dark-surface0 rounded-xl border-2 border-transparent hover:border-ctp-light-green dark:hover:border-ctp-dark-green transition-colors">
        ...
        <div className="flex flex-col items-center justify-center p-4 bg-ctp-light-surface0 dark:bg-ctp-dark-surface0 rounded-xl border-2 border-transparent hover:border-ctp-light-blue dark:hover:border-ctp-dark-blue transition-colors">
